...
interface RemboursementsHeaderProps {
  onCreateClick: () => void;
}

export default function RemboursementsHeader({ onCreateClick }: RemboursementsHeaderProps) {
  return (
    <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm">
          Suivi des crédits et des remboursements en temps réel
        </p>
      </div>
